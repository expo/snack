...
Upgrading from `snack-sdk@2`? Head over to the [Migration Guide](../docs/snack-sdk-migration.md) to see all the important changes and new APIs.
...
Head over to the [/example](./example) App for a live demo.
