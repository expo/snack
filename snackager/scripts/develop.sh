...
env-cmd --rc-file ./.env-cmdrc-void.js -e development tsnd --require tsconfig-paths/register --inspect=9212 --quiet src/index.ts | node_modules/.bin/bunyan --output simple
